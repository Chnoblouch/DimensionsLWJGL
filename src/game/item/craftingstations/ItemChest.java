...
extends Item {
	...
	public ItemChest()
	{
		setItemID(ID_CHEST);
		setHand(BOTH_HANDS);
		setName(TextLoader.getText("item_chest"));
	}
...
//		}
	...
	{
		if(inCam) screen.render(Sprites.items.getSprite(80, SPRITES_CRAFTING_STATIONS_Y, 16, 16), x, y, size, size, rot, alpha);
		else screen.renderGUI(Sprites.items.getSprite(80, SPRITES_CRAFTING_STATIONS_Y, 16, 16), x, y, size, size, rot, alpha);
	}
