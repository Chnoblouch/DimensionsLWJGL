...
//		}
	...
	{
		if(inCam) screen.render(Sprites.items.getSprite(0, SPRITES_CRAFTING_STATIONS_Y, 16, 16), x, y, size, size, rot, alpha);
		else screen.renderGUI(Sprites.items.getSprite(0, SPRITES_CRAFTING_STATIONS_Y, 16, 16), x, y, size, size, rot, alpha);
	}
