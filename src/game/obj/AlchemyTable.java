...
extends GameObject {
	...
	public void render(Screen screen)
	{
		...
		{						
//			screen.render(Sprites.getShadowStanding(sprite), getX() - 16, getY(), Block.SIZE * 4, Block.SIZE * 2, 0, 0.25); // add back in
			screen.render(Sprites.craftingstations.getSprite(144, 0, 48, 48), getX(), getY(), Block.SIZE * 2, Block.SIZE * 2, 0, 1);
		}
	}
