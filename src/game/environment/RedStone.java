...
extends GameObject {
	...
	public void render(Screen screen)
	{
		...
		{			
//			screen.render(Sprites.getShadowStanding(SpriteSheet.overworld.getSprite(0, 72, 32, 24)), 
//					      getX(), getY(), Block.SIZE * 3, Block.SIZE, 0, 0.25); // add back in
//			screen.render(Sprites.darkworld.getSprite(24, 64, 32, 24), getX(), getY(), Block.SIZE * 1.5f, Block.SIZE, 0, 1);
			...
			Sprite base = Sprites.darkworld.getSprite(24, 64, 32, 24);
	...
	public void destroy()
	{
		...
		{
			Drop drop = new Drop(new ItemRedStone(), 1);
