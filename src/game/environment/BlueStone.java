...
extends GameObject {
	...
	public void render(Screen screen)
	{
		...
		{			
//			screen.render(SpriteFilter.getShadowStanding(SpriteSheet.overworld.getSprite(0, 72,EE 32, 24)), 
//					      getX(), getY(), Block.SIZE * 3, Block.SIZE, 0, 0.25); // add back in
//			screen.render(Sprites.iceworld.getSprite(24, 24, 32, 24), getX(), getY(), Block.SIZE * 1.5f, Block.SIZE, 0, 1);
			...
			Sprite base = Sprites.iceworld.getSprite(24, 24, 32, 24);
	...
	public void destroy()
	{
		...
		{
			Drop drop = new Drop(new ItemBlueStone(), 1);
