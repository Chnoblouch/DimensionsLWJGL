...
extends GameObject {
	...
	public void render(Screen screen)
	{
		...
		{			
//			screen.render(SpriteFilter.getShadowStanding(SpriteSheet.overworld.getSprite(32, 72, 32, 24)), 
//					      getX(), getY(), Block.SIZE * 3, Block.SIZE, 0, 0.25); // add back in
//			screen.render(Sprites.overworld.getSprite(248, 72, 32, 24), getX(), getY(), Block.SIZE * 1.5f, Block.SIZE, 0, 1);
			...
			Sprite base = Sprites.overworld.getSprite(248, 72, 32, 24);
	...
	public void destroy()
	{
		...
		for(int i = 0; i < 3 + new Random().nextInt(4); i++)
		{
